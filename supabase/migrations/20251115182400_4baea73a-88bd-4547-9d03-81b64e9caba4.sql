-- Insérer des clients/usines/projets d'exemple
-- (Désactivé sur les nouveaux projets pour éviter les erreurs
--  tant que les tables n'existent pas encore. Vous pourrez
--  réactiver ces INSERT plus tard si besoin.)
--
